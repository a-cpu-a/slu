...
namespace slu::paint
{
	...
	export template<bool SRGB> struct BasicColorConverter
	{
		...
		static constexpr uint32_t tok2ColBuild(const Tok tok)
		{
			...
			case Tok::SPLICE_VAR:
				return col(0xFF00FF); //TODO: maybe some yellow? or maybe
				                      //cyan/light blue
			...
			case Tok::REP:   return col(0xA6BC6D);
			...
			default:
				...
				//return (0x122311 * uint32_t(tok) ^ 0x388831 * (uint32_t(tok) +
				//1)) | 0xFF000000;
			}
		}
