...
namespace slu::mpc
{
	...
	export template<size_t N> struct MpcMp
	{
	...
	consteval MpcItm mkItm(
	    lang::ModPathId mp, size_t localId, std::string_view str)
	{
		return MpcItm{
		    .itm = {lang::LocalObjId{localId}, mp},
              .name = str
        };
	}
...
#define _Slu_DEF_ITM(ARG_MP, _VAR, _STR)                                     \
	export constexpr ::slu::mpc::MpcItm ARG_MP##_##_VAR = ::slu::mpc::mkItm( \
	    ::slu::mpc::MP_##ARG_MP.id,                                          \
	    __COUNTER__ - (::slu::mpc::_##ARG_MP##_COUNTER_START + 1), _STR##sv)

#define _Slu_MK_COUNTER_RUN(ARG_MP)                           \
	constexpr size_t _##ARG_MP##_COUNTER_START = __COUNTER__; \
	Slu_##ARG_MP##_ITEMS(;);                                  \
	export constexpr size_t MP_ITM_COUNT_##ARG_MP             \
	    = __COUNTER__ - (_##ARG_MP##_COUNTER_START + 1)
