...
#define LUACC_SINGLE_STRING_INCOL(_COL, _TEXT)                 \
	LUACC_STRING_SINGLE "'" _COL _TEXT LUACC_END_SINGLE_STRING
#define LUACC_SINGLE_STRING(_TEXT)                       \
	LUACC_SINGLE_STRING_INCOL(LUACC_STRING_INNER, _TEXT)
