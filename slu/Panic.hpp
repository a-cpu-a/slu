...
#define Slu_panic(...) _Slu_panic_msg(__VA_ARGS__); __builtin_debugtrap()
#elif __has_builtin(__builtin_trap)
#define Slu_panic(...) _Slu_panic_msg(__VA_ARGS__); __builtin_trap()
...
#define Slu_panic(...) \
	...
	std::abort()
#else
#define Slu_panic(...) _Slu_panic_msg(__VA_ARGS__); __fastfail(0)
#endif
#else
#define Slu_panic(...) _Slu_panic_msg(__VA_ARGS__); std::abort()
#endif
